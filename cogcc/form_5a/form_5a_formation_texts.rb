...
require mappings_directory + 'cogcc_form5a_formation_texts'
...
begin
  ...
  CogccForm5aDocuments.find_by_sql("select * from cogcc_form5a_documents where approved_date is not null order by id").each do |doc|
    ...
    ActiveRecord::Base.transaction do
      ...
      if !formations.nil?
        ...
        formations.each_with_index do |f,i|
          ...
          if i > 0
            form_text = CogccForm5aFormationTexts.new
            form_text.cogcc_form5a_document_id = doc.id
            form_text.well_id = doc.well_id
            form_text.document_id = doc.document_id
            form_text.approved_date = doc.approved_date
